...
import { getSender, getSenderFull } from "../chatLogics.jsx";
      ...
      {selectedChat ? (
        <>
          ...
          <Box
            ...
            borderRadius="lg"
            overflowY="hidden"
            className="flex flex-col justify-end w-full h-[92%]"
          >
            {loading ? (
              <Spinner
                size="xl"
        ...
        <Box className="flex items-center min-h-full justify-center">
